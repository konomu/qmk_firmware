...
*/
  ...
  [_EXT] = LAYOUT_ghjis(
	...
	KC_VOLU, _______, MS_WHLU, KC_WBAK, KC_WFWD, _______, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_DEL, _______, _______,
	KC_VOLD, LCTL(KC_A),  MS_WHLD, KC_LSFT, KC_LCTL, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, _______, _______, _______,
